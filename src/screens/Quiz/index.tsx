...
import Animated, { useAnimatedStyle, useSharedValue, withSequence, withTiming, interpolate, Easing, useAnimatedScrollHandler, Extrapolate, event, runOnJS } from 'react-native-reanimated';
...
export function Quiz() {
  ...
  /*
    const onLongPress = Gesture.LongPress().minDuration(200)
      .onStart(() => {
  ...
  */
  ...
  //EQL - Lidando com o botão voltar do Android
  useEffect(() => {
